...
export default async function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-6">
      <Link
        href="/medikiosk"
        className="flex items-center justify-between rounded-xl border border-brand-200 bg-brand-50/60 px-4 py-3 text-sm transition hover:bg-brand-50"
      >
        <span className="font-medium text-brand-900">MediKiosk SIH26047 pitch site</span>
        <span className="flex items-center gap-1 text-brand-700">
          View marketing page <ArrowRight className="h-4 w-4" />
        </span>
      </Link>
